  ...
  <div class="container" @touchmove.prevent @mousewheel.prevent>
    <div class="my-tab-item-4">
      <van-dropdown-menu active-color="#ACADBB">
        <van-dropdown-item custom-class="my-dropdown-menu" :value="value1" :options="option1"
          @change="chooseDistance" />
        <van-dropdown-item :value="value2" :options="option2" @change="chooseDistance" />
      </van-dropdown-menu>
    </div>
    ...
    <div class="body">
      <div class="goods-wrapper clearfix">
        <div class="goods" v-for="(order, index) in orders" :key="index" @click="goProductionDetail">
          ...
          <div class="content">
            ...
            <div class="date">
              ...
              <div class="date-right">
                ...
                <van-circle size="50" value="25" layer-color="#D7E3FD" color="#3775F6" stroke-width="6" text="60%"
...
export default {
  ...
  methods: {
    ...
    goProductionDetail(good) {
      let param_str = encodeURIComponent(JSON.stringify(good));
      this.$push(`/pages/production-list-details/main?data=${param_str}`);
    }
  }
}
</script>
